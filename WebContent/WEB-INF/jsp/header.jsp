...
<ul id="dropdown1" class="dropdown-content blue-text ">
  <li><a class="blue-text text-darken-3" href="http://localhost:8080/E-Planner/insertDestinations.html">Add Destination</a></li>
  <li><a class="blue-text text-darken-3" href="http://localhost:8080/E-Planner/manageDestinations.html">Manage Destinations</a></li>
  <li class="divider"></li>
</ul>
<nav>
  <div class="nav-wrapper  light-blue darken-4">
    <a href="http://localhost:8080/E-Planner/index.jsp" font-style="italic" class="brand-logo">E-Planner</a>
